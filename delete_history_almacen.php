...
<?php
  ...
  if( $SuperUser["sede"]=="1"){ $tableActi="activity_tasachim";$tabla_sed="history_tasachimb";}
  ...
  if( $SuperUser["sede"]=="4"){ $tableActi="activity_vegueta";$tabla_sed="history_vegueta";}
  if( $SuperUser["sede"]=="5") {$tableActi="activity_callao";$tabla_sed="history_callao";}
  ...
  if( $SuperUser["sede"]=="10") {$tableActi="activity_exalmar_mala";$tabla_sed="history_exalmal";}
