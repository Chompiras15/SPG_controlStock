...
<?php
  ...
  if(isset($_POST['edit_cat']))
  {
    ...
    if($SuperUser["sede"]=="5")  $cat_placa = remove_junk($db->escape($_POST['placa']));
        ...
        <form method="post" action="edit_pnc_almacen.php?id=<?php echo (int)$categorie['id'];?>">
          ...
          {?> 
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" name="description" value="<?php echo remove_junk(ucfirst($categorie['description']));?>">
            </div>
          <?php }?> 
