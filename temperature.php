...
<?php
    ...
    if( $SuperUser["sede"]=="9") {$table="exalmar_temp_chim";$tableSed="sede_exalmar_chim";}
                ...
                <table style="width:100%;"class="table table-bordered table-striped table-hover" id="tabla">
                    <thead>
                        <tr>
                            ...
                            <?php if( $SuperUser["sede"]=="9") {?><th class="text-center" style="width: 10px;">Almacen</th><?php } ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           { ?> 
                            ...
                            <?php if( $SuperUser["sede"]=="9") {?><td><?php echo remove_junk(ucfirst($temp['almacen'])); ?></td> <?php } ?>
