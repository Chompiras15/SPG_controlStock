                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a style ="margin-right: 7px;padding: 5px;" href="edit_pnc_almacen.php?id=<?php echo (int)$cat['id'];?>"
                                            class="btn btn-xs btn-warning" data-toggle="tooltip" title="Editar">
                                            <span class="glyphicon glyphicon-edit" ></span>
                                        </a>
                                        <a style ="padding: 5px;" href="delete_pnc_almacen.php?id=<?php echo (int)$cat['id'];?>"
        ...
        $(document).ready(function() 
        {
            var table = $('#tabla').DataTable({
                ...
                buttons: [{
                        ...
                        today: true,
                        title: 'SGP - BUSINESS_REPORTE DE PRODUCTO NO CONFORME  '+t.getDate()+'/'+(parseInt(t.getMonth())+1)+'/'+t.getFullYear()+"  "+t.getHours()+":"+t.getMinutes()+":"+t.getSeconds(),
                    ...
                    },
                    {
                        ...
                        titleAttr: 'Imprimir',
                        title: 'SGP - BUSINESS_REPORTE DE PRODUCTO NO CONFORME',
