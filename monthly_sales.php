...
?></td>
                            <td class='text-center'><?php echo remove_junk( $sale[ 'observation' ] );
?></td>
                            <td class='text-center'><?php echo remove_junk( $sale[ 'auxiliares' ] );
?></td>
                            <td class='text-center'><?php echo remove_junk( $sale[ 'hora_ini' ] );
?></td>
                            <td class='text-center'><?php echo remove_junk( $sale[ 'hora_fin' ] );
?></td>
