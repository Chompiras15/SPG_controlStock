          ...
          <tbody>
            <?php foreach($all_users as $a_user): ?>
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-group">
                      <a href="edit_user.php?id=<?php echo (int)$a_user['id'];?>" style ="margin-right: 15px;padding: 5px;" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Editar">
      ...
      buttons: [
                  {
                    ...
                    title: 'SGP-BUSINESS-REPORTE DE USUARIOS',
