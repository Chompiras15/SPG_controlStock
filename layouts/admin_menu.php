...
<ul>
  ...
  <?php if( $SuperUser["sede"]=="T-Callao" || $SuperUser["sede"]=="T-Chimb" || $SuperUser["sede"]=="E-Chicama") {?><li><a href="almacen.php"><i class="glyphicon glyphicon-indent-left"></i><span>Almacen</span></a></li><?php } ?>
  <?php if( $SuperUser["sede"]=="T-Callao" || $SuperUser["sede"]=="T-Chimb" || $SuperUser["sede"]=="E-Chicama") {?><li><a href="embarque.php"><i class="glyphicon glyphicon-sort"></i><span>Despachos</span></a></li><?php } ?>
  <?php if( $SuperUser["sede"]=="T-Callao" || $SuperUser["sede"]=="T-Chimb" || $SuperUser["sede"]=="E-Chicama") {?><li><a href="#" class="submenu-toggle"><i class="glyphicon glyphicon-calendar"></i><span>Actividades</span></a>
