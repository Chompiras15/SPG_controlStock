...
<ul>
  ...
  <?php if( $SuperUser["sede"]=="T-Callao" || $SuperUser["sede"]=="E-Chicama") {?><li><a href="temperature.php"><i class="glyphicon glyphicon-filter"></i><span>Temperaturas</span></a></li><?php } ?>
</ul>