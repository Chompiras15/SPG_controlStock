...
<ul>
  ...
  <?php if( $SuperUser["sede"]=="T-Callao" || $SuperUser["sede"]=="E-Chimbote") {?><li><a href="temperature.php"><i class="glyphicon glyphicon-filter"></i><span>Temperaturas</span></a></li><?php } ?>
</ul>