...
<ul>
  ...
  <?php if( $SuperUser["sede"]=="5" || $SuperUser["sede"]=="1" || $SuperUser["sede"]=="4"|| $SuperUser["sede"]=="10") {?><li><a href="almacen.php"><i class="glyphicon glyphicon-indent-left"></i><span>Almacen</span></a></li><?php } ?>
  <?php if( $SuperUser["sede"]=="5" || $SuperUser["sede"]=="1" || $SuperUser["sede"]=="4"|| $SuperUser["sede"]=="10") {?><li><a href="embarque.php"><i class="glyphicon glyphicon-sort"></i><span>Despachos</span></a></li><?php } ?>
  <?php if( $SuperUser["sede"]=="5" || $SuperUser["sede"]=="1" || $SuperUser["sede"]=="4"|| $SuperUser["sede"]=="10") {?><li><a href="#" class="submenu-toggle"><i class="glyphicon glyphicon-calendar"></i><span>Actividades</span></a>
  ...
  <?php if( $SuperUser["sede"]=="10") {?><li><a href="ExalTemperature.php"><i class="glyphicon glyphicon-filter"></i><span>Temperaturas</span></a></li><?php } ?>
